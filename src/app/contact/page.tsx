  ...
  return (
    <div>
      <PageHero
        ...
        title="Contact Us"
        description="Have a question or want to enroll? We'd love to hear from you. Reach out via WhatsApp or email — we're always here to help."
      />
      ...
      <div className="mx-auto max-w-4xl px-4 py-12">
        <div className="grid gap-5 sm:grid-cols-2">
          ...
          >
            <div className="flex h-10 w-10 items-center justify-center rounded-full bg-[#25D366]/15 text-lg">💬</div>
          ...
          <a
            ...
            className="rounded-2xl border border-(--color-border) p-6 transition hover:border-(--color-primary) hover:shadow-lg hover:shadow-(--color-primary)/10"
          >
            <div className="flex h-10 w-10 items-center justify-center rounded-full bg-(--color-primary)/10 text-lg">✉️</div>
