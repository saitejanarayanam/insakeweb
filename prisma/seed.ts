...
const COURSES = [
  { slug: "cisa-certification", title: "CISA Certification", category: "it-audit", tagline: "Certified Information Systems Auditor", price: 2499900, hours: 40, difficulty: "Advanced" },
  { slug: "pmp-certification", title: "PMP Certification", category: "project-management", tagline: "Project Management Professional", price: 2999900, hours: 35, difficulty: "Intermediate" },
  { slug: "cism-certification", title: "CISM Certification", category: "security-management", tagline: "Certified Information Security Manager", price: 2699900, hours: 40, difficulty: "Advanced" },
  { slug: "crisc-certification", title: "CRISC Certification", category: "risk-management", tagline: "Risk and Information Systems Control", price: 2599900, hours: 28, difficulty: "Advanced" },
  { slug: "cissp-certification", title: "CISSP Certification", category: "security-management", tagline: "Certified Information Systems Security Professional", price: 3199900, hours: 45, difficulty: "Advanced" },
  { slug: "cgeit-certification", title: "CGEIT Certification", category: "risk-management", tagline: "Governance of Enterprise IT", price: 2599900, hours: 32, difficulty: "Advanced" },
  { slug: "cfe-certification", title: "CFE Certification", category: "fraud-examination", tagline: "Certified Fraud Examiner", price: 2399900, hours: 35, difficulty: "Intermediate" },
  { slug: "cpmai-certification", title: "CPMAI Certification", category: "ai-project-management", tagline: "AI Project Management", price: 2299900, hours: 25, difficulty: "Intermediate" },
  { slug: "equity-research-training", title: "Equity Research Training", category: "finance", tagline: "Build institutional-grade research reports", price: 1799900, hours: 20, difficulty: "Beginner" },
  { slug: "financial-analyst-training", title: "Financial Analyst Training", category: "finance", tagline: "End-to-end financial modeling", price: 1899900, hours: 30, difficulty: "Intermediate" },
  { slug: "advanced-excel", title: "Advanced Excel for Data & Business", category: "data-business", tagline: "From formulas to dashboards", price: 699900, hours: 30, difficulty: "Intermediate" },
  { slug: "power-bi", title: "Power BI for Data Analytics", category: "data-analytics", tagline: "Business intelligence dashboards", price: 899900, hours: 30, difficulty: "Intermediate" },
  { slug: "tableau", title: "Tableau for Data Visualization", category: "data-analytics", tagline: "Data visualization for analysts", price: 899900, hours: 30, difficulty: "Intermediate" },
  { slug: "python-data-analysts", title: "Python for Data Analysts", category: "data-analytics", tagline: "Python fundamentals for analytics roles", price: 999900, hours: 45, difficulty: "Intermediate" },
  { slug: "sql-data-analysts", title: "SQL for Data Analysts", category: "data-analytics", tagline: "Query and model relational data", price: 799900, hours: 30, difficulty: "Beginner" },
  { slug: "campus-to-corporate", title: "Campus to Corporate Program", category: "career-readiness", tagline: "Bridge the gap from college to your first job", price: 499900, hours: 30, difficulty: "Beginner" },
  { slug: "communication-skills", title: "Communication Skills Program", category: "soft-skills", tagline: "Speak and write with clarity and confidence", price: 399900, hours: 30, difficulty: "Beginner" },
  { slug: "personality-development", title: "Personality Development Program", category: "soft-skills", tagline: "Build presence and professional confidence", price: 399900, hours: 30, difficulty: "Beginner" },
  { slug: "presentation-skills", title: "Presentation Skills Program", category: "soft-skills", tagline: "Present ideas that land", price: 399900, hours: 21, difficulty: "Beginner" },
  { slug: "soft-skills", title: "Soft Skills Mastery Program", category: "soft-skills", tagline: "Workplace essentials for early-career professionals", price: 499900, hours: 30, difficulty: "Beginner" },
];
